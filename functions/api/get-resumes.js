...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const filtered = list
      .map(r => ({ id: r.id, matiere: r.matiere, classe: r.classe, unite: r.unite || '', sa: r.sa || '', sequence: r.sequence || '', dossier: r.dossier || '', titre: r.titre, texte: r.texte, updatedAt: r.updatedAt }))
